...
export function ContactWidget() {
  ...
  const field =
    "w-full border border-porcelain/25 bg-transparent px-3 py-2.5 text-sm text-porcelain outline-none transition-colors placeholder:text-porcelain/45 focus:border-brass";
    ...
    <>
      ...
      {open && (
        <div
          ...
          className="fixed right-5 z-[59] w-[min(23rem,calc(100vw-2.5rem))] border border-brass/45 bg-ink text-porcelain shadow-[0_24px_60px_rgba(11,27,51,0.45)]"
          style={{ bottom: "calc(5.25rem + env(safe-area-inset-bottom, 0px))" }}
        >
          {/* Header */}
          <div className="border-b border-porcelain/15 px-5 pb-4 pt-5">
            ...
            <p className="mt-1.5 text-xs leading-relaxed text-porcelain/70">
              {panel === "sent"
          ...
          {/* Write a message */}
          {panel === "form" && (
            <form onSubmit={handleSubmit} className="grid gap-3 p-5" noValidate={false}>
              <div>
                <label className={labelCls} htmlFor="zw-name">
                  Name
                </label>
                <input id="zw-name" name="name" required autoComplete="name" className={`${field} mt-1.5`} />
              </div>
              ...
              <div>
                ...
                <input id="zw-email" name="email" type="email" required autoComplete="email" className={`${field} mt-1.5`} />
              </div>
              ...
              <div>
                ...
                <input id="zw-phone" name="phone" type="tel" autoComplete="tel" className={`${field} mt-1.5`} />
              </div>
              ...
              <div>
                ...
                <select id="zw-subject" name="subject" required className={`${field} mt-1.5`} defaultValue={subjects[0]}>
                  {subjects.map((s) => (
              ...
              <div>
                ...
                <textarea id="zw-message" name="message" required rows={4} className={`${field} mt-1.5 resize-none`} />
              </div>
