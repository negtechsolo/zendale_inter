...
export default function Downloads() {
  ...
  // Read after mount: keeps the pre-rendered markup and the first client
  // render identical, and avoids touching storage on the server.
  useEffect(() => {
    try {
      if (sessionStorage.getItem("zendale-lead") === "1") setUnlocked(true);
    } catch {
      /* storage blocked */
    }
  }, []);
