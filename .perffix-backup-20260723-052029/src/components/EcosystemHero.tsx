...
export function EcosystemHero() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden" role="group" aria-label="Interactive Zendale healthcare ecosystem">
      {/*
        The SVG network is the permanent base layer. It renders in the
        pre-built HTML, never unmounts, and the 3D scene simply fades in over
        the top of it once it is ready. Previously the SVG was swapped out for
        the 3D scene, which is why the graphic appeared, vanished and came
        back on a slow connection.
      */}
      <div className="absolute inset-0">
        <NetworkGraphic animated={!reduced && !show3D} />
      </div>
